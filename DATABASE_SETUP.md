...
2. **scenarios** - Pre-built and custom training scenarios
3. **simulations** - Individual training session records
4. **performance_reports** - AI-generated feedback and recommendations
...
1. Verify tables were created in the Supabase Table Editor
2. Confirm 5 system scenarios were inserted
3. Start the application and create your first user account
